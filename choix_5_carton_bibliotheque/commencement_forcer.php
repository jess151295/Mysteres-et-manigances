<!DOCTYPE html>
    <html>
        ...
        <form method="post" action="choix_carton/choix_carton_forcer.php">
...
<br/><br/>
        ...
        <form method="post" action="choix_bibliotheque/choix_bibliotheque_forcer.php">
